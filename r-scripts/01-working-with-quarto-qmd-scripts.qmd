...
```{r}
library(tidyverse)
# define an variable A and assign the value to it 
A <-5
...
# print the result 
print (C)
# calculate the mean of the number 1,3,7,12,46
mean(1,3,7,12,46)
my_numbers <-c(1,3,12,46)
base::mean # use function mean from package base 
...
# plot as a histogram with axis label
